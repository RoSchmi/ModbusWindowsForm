...
namespace Osre.Modbus
{
   ...
   /// </remarks>
   public class RoSchmiModbusMaster
   {
      private readonly IModbusInterface _Interface;
      private readonly object _SyncObject;
      private readonly byte[] _Buffer;

      public event EventHandler<ReceivedDataEventArgs> NewSerialDataRecieved; 
   ...
   {
        public ReceivedDataEventArgs(string dataInByteArray)
        {
